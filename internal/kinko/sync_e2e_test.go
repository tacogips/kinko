...
type secretRecord struct { ID string `+"`json:\"id\"`"+`; ProjectID string `+"`json:\"projectId\"`"+`; Key string `+"`json:\"key\"`"+`; Value string `+"`json:\"value\"`"+`; Note string `+"`json:\"note\"`"+`; RevisionDate string `+"`json:\"revisionDate\"`"+` }
...
`, remoteData, stateData, stateData, stateData, journal, callLog)
